...
[ویژگی‌ها](#-ویژگی‌های-کلیدی) • [نصب سریع](#-نصب-سریع-روی-سرور) • [مسیر نصب](#-مسیر-نصب) • [لایسنس](#-لایسنس)
...
این پروژه یک قالب مدرن و پرقدرت برای جایگزینی صفحه اشتراک پیش‌فرض در پنل **3X-UI** است. این قالب با تمرکز بر سرعت بالا، زیبایی بصری و تجربه کاربری مدرن، اطلاعات حجم، زمان باقی‌مانده و کانفیگ‌های کاربر را به دقیق‌ترین شکل ممکن نمایش می‌دهد.
