...
[نسخه فارسی](README.md) | [Preview](#-visual-preview) • [Features](#-key-features) • [Quick Install](#-quick-installation) • [Installation Path](#-installation-path) • [Manual Deployment](#-manual-deployment) • [License](#-license)
